...
% param = load('PID_Parameters'); % Load parameters from a former run

global NFE; % Number of Function Evaluations
NFE=0;

CostFunction=@(x) pid_cost_function(x);     % Cost Function
...
% pop = param.pop;
% pop(1).Position=unifrnd(VarMin,VarMax);
for i=1:nPop
